...
class WebsocketClientService
{
    ...
    public function __construct($_host = '127.0.0.1',$port = 9521,$path = '/ws')
    {
        $this->connect($_host, $port, $path);
    }
...
////$client->connect($_SERVER['HTTP_HOST'], 8866, '/wss');
//$data = [
//    'code' => 213213123,
//];
//$rs = $client->sendData(json_encode($data));
//echo $rs;
//$client->disconnect();
